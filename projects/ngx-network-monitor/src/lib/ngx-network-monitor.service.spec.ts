...
import { NgxNetworkMonitorService, NetworkStatus } from './ngx-network-monitor.service';
import { HttpClientTestingModule, HttpTestingController } from '@angular/common/http/testing';
import { PING_URL } from './tokens/ping-url.token';
import { NgZone, PLATFORM_ID } from '@angular/core';

describe('NgxNetworkMonitorService', () => {
  let service: NgxNetworkMonitorService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(NgxNetworkMonitorService);
